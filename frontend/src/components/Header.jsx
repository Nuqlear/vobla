...
export default class Header extends Component {
  ...
  _handlePageClick = e => {
    ...
    if (!wasDown && !wasUp) this.hideDropdown()
  }
      ...
      navbarRight = (
        <ul className="navbar-nav justify-content-end">
          ...
          <li
            ...
            onMouseDown={this.handleMouseDownOnDropDown}
            onMouseUp={this.handleMouseUpOnDropDown}
          >
            {user} &#x25BE;
          </li>
        </ul>
    ...
    return (
      <div className="root secondary-color-background">
        <div className="navigation">
          ...
          <ul
            className={
              this.state && this.state.dropdownShown
                ? 'dropdown-menu active'
                : 'dropdown-menu'
            }
            onMouseDown={this.handleMouseDownOnDropDown}
            onMouseUp={self.handleMouseUpOnDropDown}
          >
            <Link to="/getapp" className="dropdown-item">
              Get app
            </Link>
            {this.navbarRight.map(function(el, index) {
              return (
                <li
                  ...
                  onClick={e => {
                    self.hideDropdown() || el.onClick(e)
                  }}
                  key={index}
                >
                  {el.jsx}
